...
\readarray\branchidss\branchids[1,2]
...
\addplot[red, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/\branchids[1,1].csv};
\addplot[violet,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/8.csv};
\addplot[MyGreen, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_u/0_bis.csv};
\addplot[MyGreen, dashed, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_u/4_bis.csv};
\addplot[teal,line width=0.6] table [col sep=comma, smooth,mark=none,forget plot] {../diagram_u/116_bis.csv};
\addplot[violet, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/14.csv};
%\addplot[MyGreen,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/18.csv};
\addplot[red,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/400.csv};
\addplot[red,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/90.csv};
\addplot[blue,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/284.csv};
\addplot[brown,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/410.csv};
\addplot[brown,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/737.csv};
\addplot[blue, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_u/0.csv};
\addplot[orange, dashed, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_u/34.csv};
\addplot[orange, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_u/44.csv};
\addplot[MyGreen, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_u/89.csv};
...
\begin{axis}[xshift=280, xmin=0, xmax=10^5, ymin=0.22, ymax=0.4, x label style={at={(0.5,-0.07)}}, xlabel={$\textrm{Ra}$},
...
\addplot[red, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/36.csv};
\addplot[violet,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/958.csv};
\addplot[MyGreen, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_T/0_bis.csv};
\addplot[MyGreen, dashed, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_T/4_bis.csv};
\addplot[teal, line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/116_bis.csv};
\addplot[violet, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/14.csv};
\addplot[MyGreen,line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_T/89.csv};
\addplot[red,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/400.csv};
\addplot[red,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/90.csv};
\addplot[blue,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/284.csv};
\addplot[brown,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/410.csv};
\addplot[brown,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/737.csv};
\addplot[blue, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_T/0.csv};
\addplot[orange, dashed, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_T/34.csv};
\addplot[orange, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_T/44.csv};
...
\begin{axis}[xshift=140, yshift=-210, xmin=0, xmax=10^5, ymin=1, ymax = 4.5, x label style={at={(0.5,-0.07)}}, xlabel={$\textrm{Ra}$}, y label style={at={(-0.15,0.45)}, rotate=-90,anchor=south},ylabel={$\textrm{Nu}$},  every x tick scale label/.style={at={(xticklabel cs:1)},anchor=south west, yshift=-0.11em},xtick scale label code/.code={\pgfmathparse{int(#1)}$\times 10^{\pgfmathresult}$}, legend style={at={(1.1,1)},anchor=north west}, ytick={0,1,2,3,4,4.5}]
\addplot[red, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/36.csv}; % 1
\addplot[blue, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/0.csv}; % 2
\addplot[MyGreen, dashed, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_N/0_bis.csv}; % 3
\addplot[MyGreen, dashed, line width=0.6] table [col sep=comma, smooth,mark=none,forget plot] {../new_branches/diagram_N/4_bis.csv}; %3
\addplot[violet, dashed,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/14.csv}; %4
\addplot[orange, dashed, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_N/34.csv}; % 5
\addplot[orange, line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_N/44.csv}; % 6
\addplot[MyGreen,line width=0.6] table [col sep=comma, smooth,mark=none] {../new_branches/diagram_N/89.csv}; % 7
\addplot[blue,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/284.csv}; % 8
\addplot[brown,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/410.csv}; % 9
\addplot[brown,line width=0.6] table [col sep=comma, smooth,mark=none,forget plot] {../diagram_N/737.csv};
\addplot[violet,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/8.csv}; %10
\addplot[red,line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/400.csv}; % 11
\addplot[red,line width=0.6] table [col sep=comma, smooth,mark=none,forget plot] {../diagram_N/90.csv}; % 11
\addplot[teal, line width=0.6] table [col sep=comma, smooth,mark=none] {../diagram_N/116_bis.csv}; % 12
